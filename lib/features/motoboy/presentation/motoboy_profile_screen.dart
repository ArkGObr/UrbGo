...
class MotoboyProfileScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MotoboyProfileScreen> createState() => _MotoboyProfileScreenState();
}
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (_selectedImage != null) {
        ...
        final uploadPath = '${user.id}/avatar-${DateTime.now().millisecondsSinceEpoch}.$ext';
      ...
      await Supabase.instance.client.from('motoboys').update({
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Ex: Prezo pela agilidade e cuidado com sua entrega!',
